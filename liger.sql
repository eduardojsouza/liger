...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Out-2015 às 12:54
...
(18, 'AnoBaseList', 'AnoBaseList'),
(19, 'AnoBaseForm', 'AnoBaseForm'),
(20, 'PlantaValoresList', 'PlantaValoresList'),
(21, 'PlantaValoresForm', 'PlantaValoresForm');
...
--
-- Estrutura da tabela `tb_anobase`
--

CREATE TABLE IF NOT EXISTS `tb_anobase` (
  `anobase_id` int(12) NOT NULL,
  `anobase_data` year(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_anobase`
--

INSERT INTO `tb_anobase` (`anobase_id`, `anobase_data`) VALUES
(1, 2014),
(2, 2015);
...
--
-- Estrutura da tabela `tb_zonafiscal`
--
